...
@php
    $classes = ($active ?? false)
        ? 'flex items-center px-4 py-2 w-full text-sm font-medium text-theme-from bg-theme-from/10 rounded-md focus:outline-none hover:bg-theme-from/20 transition duration-150 ease-in-out'
