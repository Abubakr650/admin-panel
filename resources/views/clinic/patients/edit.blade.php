    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <div>
                ...
                <h1 class="text-xl font-bold text-gray-800">Edit Patient</h1>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="bg-gradient-to-r from-theme-from to-theme-to px-8 py-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-white text-xl font-bold">Patient Record Update</h2>
                            <p class="text-sky-100 text-sm mt-0.5">Review and update the patient's information below</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('patients.update', $patient->id) }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" rows="2"
                                ...
                                class="{{ $inputClass('address') }} resize-none">{{ old('address', $patient->address) }}</textarea>
