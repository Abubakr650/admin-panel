    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <div>
                ...
                <h1 class="text-xl font-bold text-gray-800">Edit Batch</h1>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="bg-gradient-to-r from-theme-from to-theme-to px-8 py-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-white text-xl font-bold">Edit Batch</h2>
                            <p class="text-sky-100 text-sm mt-0.5">Batch #{{ $item->batch_number }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-8 py-7">
                    ...
                    <form action="{{ route('pharmacy.batches.update', $item->id) }}" method="POST" class="space-y-5"
                        x-data="{ 
                            selectedItemId: '{{ old('pharmacy_item_id', $item->pharmacy_item_id) }}',
                            qrInput: '',
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input type="text" id="batch_number" name="batch_number"
                                value="{{ old('batch_number', $item->batch_number) }}" required
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" id="expiry_date" name="expiry_date"
                                    value="{{ old('expiry_date', $item->expiry_date?->format('Y-m-d')) }}" required
