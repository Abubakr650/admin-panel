    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <div>
                ...
                <h1 class="text-xl font-bold text-gray-800">Add New Inventory Item</h1>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="bg-gradient-to-r from-theme-from to-theme-to px-8 py-6">
                    <div class="flex items-center gap-4">
                        <div class="w-14 h-14 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-inner">
                            <x-icon name="library" class="w-7 h-7 text-white" />
                        </div>
                        <div>
                            <h2 class="text-white text-xl font-bold">New Inventory Item</h2>
                            <p class="text-sky-100 text-sm mt-0.5">Enter item details to add to warehouse stock</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-8 py-7">
                    ...
                    <form action="{{ route('pharmacy.warehouse.store') }}" method="POST" class="space-y-5">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="location_in_warehouse" name="location_in_warehouse"
                                    value="{{ old('location_in_warehouse') }}"
