            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="bg-gradient-to-r from-theme-from to-theme-to px-8 py-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-white text-xl font-bold">Edit Supplier</h2>
                ...
                <div class="px-8 py-7">
                    ...
                    <form action="{{ route('pharmacy.suppliers.update', $item->id) }}" method="POST" class="space-y-5">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" rows="2"
                                ...
                                class="{{ $inputClass('address') }} resize-none">{{ old('address', $item->address) }}</textarea>
